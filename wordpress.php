...
<div class="container-fluid mb-5">
  ...
  <div class="row">
    <div class="small-12 medium-12 large-12 columns">
      <h2 class="text-center">Wordpress</h2>To add menus in wordpress use the wp_nav_menu function functions.php is where everything is to add extra functions to a site that help improve the site add an includes folder and functions-extra.php page <h6>Get Page Link From Slug</h6>
      <code class="language-php">echo get_permalink(get_page_by_path('Insert Permalink Here'));</code>
    </div>
  </div>
