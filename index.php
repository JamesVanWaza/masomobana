  ...
  <section class="row">
    <article class="col-lg-3 col-md-6 col-sm-12">
      ...
      <ul class="no-bullet">
        ...
        <li class="zelinks"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript" target="_blank">JS <i class="fa-solid fa-link"></i></a></li>
    ...
    <article class="col-lg-3 col-md-6 col-sm-12">
      ...
      <ul class="no-bullet">
        ...
        <li class="zelinks"><a href="https://badwf.dostesting.co.ke" target="_blank">BADWF <i class="fa-solid fa-link"></i></a></li>
        <li class="zelinks"><a href="https://b5e.dostesting.co.ke" target="_blank">Bootstrap 5 Examples <i class="fa-solid fa-link"></i></a></li>
        <li class="zelinks"><a href="https://dostesting.co.ke" target="_blank">Dosbootstrap <i class="fa-solid fa-link"></i></a></li>
        <li class="zelinks"><a href="https://fis.dostesting.co.ke" target="_blank">FIS <i class="fa-solid fa-link"></i></a></li>
        <li class="zelinks"><a href="https://heart4kids.dostesting.co.ke" target="_blank">Heart 4 Kids <i class="fa-solid fa-link"></i></a></li>
        <li class="zelinks"><a href="https://kenafrica-bootstrap.dostesting.co.ke" target="_blank">Kenafrica Bootstrap <i class="fa-solid fa-link"></i></a></li>
        <li class="zelinks"><a href="https://start-sass.dostesting.co.ke" target="_blank">Start SASS<i class="fa-solid fa-link"></i></a></li>
        <li class="zelinks"><a href="https://tailwind-start.dostesting.co.ke" target="_blank">Tailwind <i class="fa-solid fa-link"></i></a></li>
  ...
  <section class="row">
    <article class="col-lg-3 col-md-6 col-sm-6">
      ...
      <ul class="no-bullet">
        ...
        <li class="zelinks"><a href="https://www.zeldman.com/" target="_blank">Zeldman <i class="fa-solid fa-link"></i></a></li>
    ...
    <article class="col-lg-3 col-md-6 col-sm-12 ">
      ...
      <ul class="no-bullet">
        ...
        <li class="zelinks"><a href="https://skylinedesign.co.ke/" target="_blank">Skyline Design <i class="fa-solid fa-link"></i></a></li>
        <li class="zelinks"><a href="https://www.gravitatedesign.com/" target="_blank">Gravitate Design <i class="fa-solid fa-link"></i></a></li>
        <li class="zelinks"><a href="https://michaelkamuiru.info/" target="_blank">Michael Kamuiru <i class="fa-solid fa-link"></i></a></li>
        <li class="zelinks"><a href="https://www.oho.com/" target="_blank">OHO Interactive <i class="fa-solid fa-link"></i></a></li>
        <li class="zelinks"><a href="https://expo.getbootstrap.com/" target="_blank">Bootstrap Expo <i class="fa-solid fa-link"></i></a></li>
        <li class="zelinks"><a href="https://www.kevinleary.net/" target="_blank">Kevin Leary <i class="fa-solid fa-link"></i></a></li>
  ...
  <section class="row">
    <article class="col-lg-3 col-md-6 col-sm-12 ">
        ...
        <ul class="no-bullet">
          ...
          <li class="zelinks"><a href="http://emmet.io/" target="_blank">Emmet <i class="fa-solid fa-link"></i></a></li>
    ...
    <article class="col-lg-3 col-md-6 col-sm-6">
      ...
      <ul class="no-bullet">
        ...
        <li class="zelinks"><a href="https://html5boilerplate.com/" target="_blank">HTML5 Boilerplate <i class="fa-solid fa-link"></i></a></li>
  ...
  <section class="row">
    <article class="col-lg-6 col-md-6 col-sm-6">
      ...
      <ul class="no-bullet">
        ...
        <li class="zelinks"><a href="https://underscores.me" target="_blank">Underscores <i class="fa-solid fa-link"></i></a></li>
        <li class="zelinks"><a href="https://roots.io" target="_blank">Roots IO <i class="fa-solid fa-link"></i></a></li>
        <li class="zelinks"><a href="https://jointswp.com" target="_blank">Joints WP <i class="fa-solid fa-link"></i></a></li>
        <li class="zelinks"><a href="https://themble.com/bones" target="_blank">Themble Bones <i class="fa-solid fa-link"></i></a></li>
    ...
    <article class="col-lg-6 col-md-6 col-sm-6">
      ...
      <ul class="no-bullet">
        ...
        <li class="zelinks"><a href="https://gratisography.com" target="_blank">Gratisography <i class="fa-solid fa-link"></i></a></li>
        <li class="zelinks"><a href="https://nos.twnsnd.co" target="_blank">New Old Stock <i class="fa-solid fa-link"></i></a></li>
        <li class="zelinks"><a href="https://getrefe.tumblr.com" target="_blank">Free Refe Mobile Photos <i class="fa-solid fa-link"></i></a></li>
